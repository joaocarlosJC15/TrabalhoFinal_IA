...
import { ResultadoAlgoritmoGenetico_AG } from './models/resultadoAlgoritmoGenetico_AG';
...
export class AlgortimoGenetico{
  ...
  public gerarHorario(): ResultadoAlgoritmoGenetico_AG {
    ...
    const resultado = new ResultadoAlgoritmoGenetico_AG(
      this.tamanhoPopulacao,
      this.numeroGeracoesExecutadas,
      this.tamanhoTorneio,
      this.taxaCruzamento,
      this.taxaMutacao,
      this.elitismo,
